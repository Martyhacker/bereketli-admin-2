                        ...
                        <div className="card">
                            <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                ...
                                <div className="social-links mt-2">
                                    <a href="#" className="twitter"><i className="bi bi-telephone-fill"></i></a>
                                    <a href="#" className="facebook"><i className="bi bi-telegram"></i></a>
                                    <a href="#" className="instagram"><i className="bi bi-envelope"></i></a>
                                </div>
                            </div>
                        </div>
